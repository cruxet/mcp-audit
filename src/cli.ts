...
const program = new Command()
  .name('mcp-audit')
  .description('Security scanner for Model Context Protocol (MCP) configurations.')
  .version(VERSION)
...
program.action(async (rawOpts: CliOptions) => {
...
function normalizeOpts(raw: CliOptions): CliOptions {
